...
export const ProductListing: React.FC<ProductListProps> = ({ product_list }) => {
    return (
        <GridBox columns={1}  className='pt-0 py-5 px-0 xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-0 grid dilip xl:grid-cols-[1fr] lg:grid-cols-[1fr] md:grid-cols-[1fr] grid-cols-[1fr_1fr] xl:gap-5 lg:gap-5 md:gap-5 gap-3'>
                ...
                return (
                    <GridBox.GridItem key={index} columnMerge={1} className='gap-3'>
                        <GridBox columns={4} gap={5} className='xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-7 sm:grid'>
                            <GridBox.GridItem columnMerge={1} className='dilip'>
                                <Image
                            ...
                            <GridBox.GridItem columnMerge={3} className='leading-[37px]'>
                                ...
                                <p className='space-y-2.5'>
                                    <span className='xl:text-[18px] lg:text-[18px] md:text-[18px] text-[14px] relative -top-2 xl:text-black lg:text-black md:text-black text-accentColor' >{item.currancy}</span>
