    ...
    <Slider className="custom-slick-slider" {...settings}>
      {slider.map((item, index) => (
        <div key={index} className='hero-slider' >
          <div className='bg-cover bg-no-repeat xl:py-[100px] lg:py-[100px] md:py-[100px] py-[50px] bg-left-top ' style={{ backgroundImage: `url(${item.image})` }}>
            <GridBox columns={3} className='px-[3%] sm:grid'>
