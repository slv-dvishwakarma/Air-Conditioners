...
export const Header = () => {
  ...
  return (
    <>
      ...
      {jsonFile.style && (
        <HeaderTemplatetwo header_data={jsonFile.template_2} search={jsonFile.template_2.search} button={jsonFile.template_2.button} login_form={jsonFile.login_form} signup_form={jsonFile.signup_form} myaccount={jsonFile.template_2.account} logout={jsonFile.template_2.logout}/>
      )}
    </>
  );
};
